...
public class GameEngineTestTerminal {
  ...
  @Test
  public void testInvalidHandleGoCommandOneWord() {
    gameEngine.setRoom(layout.findByRoomName(layout.getRooms(), "Bathroom"));

    gameEngine.runGame(terminal.handleInput("gOhere"), gameEngine);

    Assert.assertEquals("Bathroom", gameEngine.getRoom().getName());
  }

  @Test
  public void testInvalidHandleGoCommandJustGo() {
    gameEngine.setRoom(layout.findByRoomName(layout.getRooms(), "Bathroom"));

    gameEngine.runGame(terminal.handleInput("go"), gameEngine);

    Assert.assertEquals("Bathroom", gameEngine.getRoom().getName());
  }

  @Test
  public void testValidHandleExamineCommand() {
  ...
  @Test
  public void testInvalidHandleExamineCommand() {
    gameEngine.setRoom(layout.findByRoomName(layout.getRooms(), "Cell Block A"));

    gameEngine.runGame(terminal.handleInput("exAmIne the command"), gameEngine);
  ...
  @Test
  public void testValidHandleDropCommandAlreadyInRoom() {
    gameEngine.setRoom(layout.findByRoomName(layout.getRooms(), "Bathroom"));
  ...
  @Test
  public void testInvalidHandleDropCommandNotWithPlayer() {
    gameEngine.setRoom(layout.findByRoomName(layout.getRooms(), "Bathroom"));
  ...
  public void testValidHandleQuitCommand() {
    ...
    gameEngine.runGame(terminal.handleInput("qUIt        "), gameEngine);
  ...
  public void testInvalidWord() {
    ...
    gameEngine.runGame(terminal.handleInput("thAnks        "), gameEngine);
  ...
  public void testInvalidWords() {
    ...
    gameEngine.runGame(terminal.handleInput("thAnks for letting me play!!!    "), gameEngine);
